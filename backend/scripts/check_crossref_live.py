"""
One-off manual sanity check against the real Crossref API.
Not part of the test suite - run directly:
    docker compose exec backend python scripts/check_crossref_live.py
"""
...
async def main():
    ...
    print("Querying Crossref for 'large language models' (max_results=5)...\n")
